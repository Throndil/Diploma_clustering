# https://www.youtube.com/watch?v=otjWCaMcVaA&ab_channel=Dr.BharatendraRai
# https://github.com/bkrai/Top-10-Machine-Learning-Methods-With-R
...
kc<-kmeans(nor,4)
kc
clusplot(mydata, kc$cluster, color = T, shade = T, labels = 2, lines = 0)
